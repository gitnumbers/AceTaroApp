...
import { StyleSheet, Text, View, Image, TouchableOpacity, ScrollView, ImageBackground, Dimensions, TouchableWithoutFeedback, LogBox, ActivityIndicator} from 'react-native';
        ...
        <View  style={[styles.fixed, styles.containter]}>
            ...
            <View style={[styles.cardContainer, styles.cardRowArea]}>
                <TouchableWithoutFeedback onPress={somethingDoFunction}>
                    ...
                    }} style={styles.cardImage} source={{uri:card_image}}/>
